...
<head>
    <h1 style="text-align:left; color:rgb(25, 0, 255);">Scientific Calculator</h1>
...
<body>
    ...
    <br>
    <p style="color:rgb(13, 42, 173)";> Note- Wait for the operator to vanish to input second operand.</p><br>
    P.S.- Nothing is Bug free.
</body>
</html>